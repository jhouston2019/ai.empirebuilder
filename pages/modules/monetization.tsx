      ...
      <div className="sticky top-0 z-10 bg-black/90 backdrop-blur-sm border-b border-neutral-700 p-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold text-yellow-400">Module 4: Monetization Mastery</h1>
          </div>
          <div className="flex items-center gap-4">
            <a
              href={`/api/modules?file=${encodeURIComponent("Module 4 - Workbook - Monetization Mastery.html")}`}
              target="_blank"
